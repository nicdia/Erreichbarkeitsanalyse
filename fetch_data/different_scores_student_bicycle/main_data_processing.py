...
def main_processing():
    # set up
    with open("C:\\Master\\GeoinfoPrj_Sem1\\Erreichbarkeitsanalyse\\fetch_data\\different_scores_student_bicycle\\config_data_processing.json", "r") as file:
...
###################################################
    ...
    if intersect_config:
        ...
        for run in intersect_config:
            ...
            execute_intersect_count_adding (run, db_con, "students_21132231")
