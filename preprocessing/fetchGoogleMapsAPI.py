...
#     ## old config - that way I received Parks, Spielplatz and Kinderzahnarzt data
...
def fetch_places_multiple_locations(search_type, filename, keyword=None):
    ## adjusted function to get more precise dentist data --> added more locations to go through more spots in Hamburg in order to get better data quality

    base_url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json"

    # Liste der zentralen Punkte in Hamburg, um die Stadt abzudecken
    locations = [
        "53.5511,9.9937",  # Hamburg Zentrum (Mitte)
        "53.6300,10.0100",  # Nordwesten (St. Pauli)
        "53.5650,10.0000",  # Nordosten (Barmbek)
        "53.4850,9.9490",   # Südwesten (Altona)
        "53.5078,9.9672",   # Süden (Harburg)
        "53.5630,9.9260",   # Osten (Bergedorf)
        "53.5397,9.9575",   # Westen (Eimsbüttel)
        "53.5760,10.2250",  # Nordosten (Langenhorn)
        "53.4740,9.7790",   # Südost (Marmstorf)
        "53.4750,10.0130"   # Südwesten (Bahrenfeld)
    ]
    all_results = []
    for location in locations:
        params = {
...
fetch_places_multiple_locations(search_type="zahnarzt", filename="zahnarzt_hamburg2.geojson", keyword= "Zahnarzt Hamburg")
